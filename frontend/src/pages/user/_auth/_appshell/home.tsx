            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {cards.map((card) => (
                    <Link
                        key={card.id}
                        to={card.link}
                        className="group block p-6 rounded-lg border-2 border-gray-200 hover:border-[#F4802F] hover:shadow-[0_0_0_1px_#F4802F] transition-all duration-300 relative overflow-hidden h-60 bg-white hover:bg-[rgba(255,194,152,0.25)]"
                    >
