...
function FundingModal({
    ...
    const amoutInputID = useRandomId();
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            try {
                ...
                const [teamData, documentsData, commentsData] =
                    await Promise.all([
                ...
                if (documentsData.documents.length > 0) {
                    ...
                    const sortedDocs = [...documentsData.documents].sort(
                ...
                if (commentCount > 0) {
                    ...
                    history.push({
                        date: new Date(
                            Math.max(
                                ...commentsData.comments.map((c) => c.createdAt)
                            ) * 1000
                        ).toLocaleDateString('en-US', {
                            year: 'numeric',
                            month: 'long',
                        ...
                        <button
                            ...
                            title={
                                !company.wallet_address
                                    ? "Company hasn't set up their wallet address"
                                    : ''
                            }
                    ...
                    <div className="grid grid-cols-5 gap-4 mb-6">
                        ...
                        <div className="p-4 bg-white rounded-lg border border-gray-200">
                            ...
                            <p className="mt-1 font-medium">
                                {projectStats?.submittedDate || 'Not submitted'}
                            </p>
                        </div>
                        <div className="p-4 bg-white rounded-lg border border-gray-200">
                            <h3 className="text-sm text-gray-500">
                            ...
                            <p className="mt-1 font-medium">
                                {projectStats?.documentsCount || 0} documents
                            </p>
                        </div>
                        <div className="p-4 bg-white rounded-lg border border-gray-200">
                            <h3 className="text-sm text-gray-500">
