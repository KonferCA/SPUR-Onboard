...
const AdminProjectsPage: React.FC = () => {
    ...
    const filteredProjects = projects.filter((project) => {
        ...
        if (
            ...
            project.company_stage !== filters.companyStage
        )
            return false;
    ...
    const companyStages = [...new Set(projects.map((p) => p.company_stage))];
    const years = [
        ...new Set(
            projects
                .map((p) =>
...
export const Route = createFileRoute('/admin/_auth/_appshell/projects/')({
