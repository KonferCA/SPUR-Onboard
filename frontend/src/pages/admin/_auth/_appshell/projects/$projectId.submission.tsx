...
const ProjectSubmissionPage: React.FC = () => {
  const params = useParams({
    from: '/admin/_auth/_appshell/projects/$projectId/submission',
  })
  ...
  // TODO: This page shares the same layout for project submission so a new layout
  // other than appshell should be made so that the custom side bar can be put there
  // instead of here.
  //
  // Code commented because the custom side bar could be better put somewhere
  // or updating the template/layout would be better
                  ...
                  {section.questions?.length > 0 ? (
                    section.questions.map((q, idx) => (
                      ...
                      >
                        ...
                        <div className="text-gray-900">{q.answer}</div>
                      </div>
                    ))
                  ) : (
