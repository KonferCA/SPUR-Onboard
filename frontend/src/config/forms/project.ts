...
export const projectFormSchema: FormStep[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: 'Please do not go into detail about your product in this section, you will have a chance to do so in the following sections of the form.',
        fields: [
          {
            id: 'description',
            type: 'textarea',
      ...
      },
      {
        ...
        description: 'Please share with us your online presence so we can get a better understanding of your organization\'s identity. You can share pages like your website, LinkedIn, Instagram etc...',
        fields: [
          {
            id: 'social-links',
            type: 'social-links',
    ...
    sections: [
      {
        ...
        description: 'To help us verify your organization\'s legitimacy, please provide us with business related documents.',
        fields: [
          {
            id: 'documents',
            type: 'file',
