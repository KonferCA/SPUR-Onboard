...
describe('ConfirmationModal', () => {
    ...
    it('calls onClose when secondary button is clicked', () => {
        render(
            <ConfirmationModal {...defaultProps} secondaryActionText="Cancel" />
        );
    ...
    it('calls primaryAction when primary button is clicked', () => {
        render(
            <ConfirmationModal {...defaultProps} primaryActionText="Confirm" />
        );
    ...
    it('renders additionalButtons when provided', () => {
        const additionalButton = (
            <button type="button" data-testid="additional-button">
                Extra Action
            </button>
        );
