...
export const RecommendedFields: React.FC<RecommendedFieldsProps> = ({
    ...
    const handleFieldClick = (field: RecommendedField, e: React.MouseEvent) => {
        ...
        onFieldClick(
            field.section,
            sanitizeHtmlId(field.subsection),
            field.questionId
        );
    };
        ...
        <div className="space-y-4">
            <div className="border-b border-gray-200 pb-4">
                <p className="text-gray-600">
                    ...
                    Consider adding information to make your submission more
                    complete.
                </p>
            </div>
            ...
            <div className="max-h-[60vh] overflow-y-auto pr-2">
                ...
                <p className="text-sm text-gray-600 mt-4">
                    Click on any field to navigate to it. You can continue with
                    submission even if these fields are empty.
                </p>
            </div>
        </div>
    );
